...
С текстом дипломной работы, презентацией для защиты, отзывами от научного руководителя и рецензента можно ознакомиться в папке [diploma]().

В папке [jmlc]() дополнительно находятся:
- Отзыв тимлида
